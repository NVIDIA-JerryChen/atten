...
def _flash_attn_forward(
    ...
    block_sparse_blocksize_m: int = -1,
    block_sparse_blocksize_n: int = -1,
    ...
    with torch.cuda.nvtx.range("flash_varlen_fwd_kernel"):
        out, softmax_lse, out_accum, softmax_lse_accum = flash_attn_3_cuda.fwd(
            ...
            block_sparse_blocksize_m,
            block_sparse_blocksize_n,
            softmax_scale,
            causal,
            window_size_left,
            window_size_right,
...
def _flash_attn_backward(
    ...
    with torch.cuda.nvtx.range("flash_varlen_bwd_kernel"):
...
class FlashAttnFunc(torch.autograd.Function):
    ...
    def forward(
        ...
        out, softmax_lse, *rest = _flash_attn_forward(
            ...
            None, None, None,  # rotary_cos/sin, seqlens_rotary
            q_descale, k_descale, v_descale,
            block_sparse_indices, block_sparse_blocksize_m, block_sparse_blocksize_n,
            softmax_scale,
            causal=causal,
            window_size_left=window_size[0],
            window_size_right=window_size[1],
